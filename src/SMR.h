    ...
    namespace control
    {
        ...
        public:
            ...
            /** \brief Set the connection strategy function that specifies the
             ...
             \par The behavior and performance of SMR can be changed drastically
            ...
            /** \brief Attempt to connect disjoint components in the roadmap
                using random bouncing motions (the SMR expansion step) for the
                given time (seconds). */
            void expandRoadmap(double expandTime);

            /** \brief Attempt to connect disjoint components in the roadmap
                using random bouncing motions (the SMR expansion step) until the
            ...
            /** \brief Function that can solve the motion planning
                ...
                added, not removed. When using SMR as a multi-query
            ...
            /** \brief Clear the query previously loaded from the ProblemDefinition.
                ...
                This enables multi-query functionality for SMR. */
        ...
        protected:
            ...
            /** \brief Attempt to connect disjoint components in the
                roadmap using random bounding motions (the SMR
                expansion step) */
            ...
            /** \brief Objective cost function for SMR graph edges */
